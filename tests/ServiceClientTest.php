...
class ServiceClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testExecuteBatch()
    {
        ...
        // Execute the batch.
        $results = $client->batch($generateCommands(), $options);
    ...
    public function testBatchFailsForNonCommands()
    {
        $generateCommands = function () {
            yield 'foo';
        };
